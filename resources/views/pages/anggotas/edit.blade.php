                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="nip_nipb_nrptt" name="nip_nipb_nrptt"
                                    value="{{ $anggota->nip_nipb_nrptt }}" required>
                            </div>
                            <div class="mb-3 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="status_kepegawaian"
                                    name="status_kepegawaian" value="{{ $anggota->status_kepegawaian }}" required>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="status_pernikahan" class="form-label">Status Pernikahan</label>
                                <input type="text" class="form-control" id="status_pernikahan"
                                    name="status_pernikahan" value="{{ $anggota->status_pernikahan }}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" class="form-control" id="simpanan_wajib" name="simpanan_wajib"
                                    value="{{ $anggota->simpanan_wajib }}" required>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="waktu_pembayaran" class="form-label">Waktu Pembayaran</label>
                                <select class="form-select" id="waktu_pembayaran" name="waktu_pembayaran" required>
                                    <option value="1" {{ $anggota->waktu_pembayaran == 1 ? 'selected' : '' }}>Rp
                                        200.000 (bayar 1X)</option>
                                    <option value="2" {{ $anggota->waktu_pembayaran == 2 ? 'selected' : '' }}>Rp
                                        100.000 (bayar 2X)</option>
                                    <option value="4" {{ $anggota->waktu_pembayaran == 4 ? 'selected' : '' }}>Rp
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select" id="pembayaran" name="pembayaran">
                                    <option value="" {{ is_null($anggota->pembayaran) ? 'selected' : '' }}>Otomatis
                                    </option>
                                    <option value="1" {{ $anggota->pembayaran == 1 ? 'selected' : '' }}>Manual
                                    </option>
                                </select>
                            </div>
                        </div>
