...
@section('main')
    <div class="container-fluid">
        ...
        @php
            $totalSurat = $data->count();
            $totalProses = $data->where('status_surat', 'proses')->count();
            $totalPengajuan = $data->where('status_surat', 'pengajuan')->count();
            $totalSelesai = $data->where('status_surat', 'selesai')->count();
        @endphp
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="text-muted text-uppercase fs-13 mt-0">Total Surat</h5>
                                <h3 class="my-3">{{ $totalSurat }}</h3>
                                <p class="mb-0 text-muted text-truncate">Semua jenis surat terdaftar</p>
                            </div>
                            <div class="avatar-sm flex-shrink-0">
                                <span class="avatar-title text-bg-primary rounded fs-3 widget-icon-box-avatar shadow">
            ...
            <div class="col">
                <div class="card widget-icon-box">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="text-muted text-uppercase fs-13 mt-0">Status Proses</h5>
                                <h3 class="my-3">{{ $totalProses }}</h3>
                                <p class="mb-0 text-muted text-truncate">Surat dalam proses</p>
                            </div>
                            <div class="avatar-sm flex-shrink-0">
                                <span class="avatar-title text-bg-warning rounded fs-3 widget-icon-box-avatar shadow">
            ...
            <div class="col">
                <div class="card widget-icon-box">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="text-muted text-uppercase fs-13 mt-0">Status Pengajuan</h5>
                                <h3 class="my-3">{{ $totalPengajuan }}</h3>
                                <p class="mb-0 text-muted text-truncate">Menunggu persetujuan</p>
                            </div>
                            <div class="avatar-sm flex-shrink-0">
                                <span class="avatar-title text-bg-info rounded fs-3 widget-icon-box-avatar shadow">
            ...
            <div class="col">
                <div class="card widget-icon-box">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="text-muted text-uppercase fs-13 mt-0">Status Selesai</h5>
                                <h3 class="my-3">{{ $totalSelesai }}</h3>
                                <p class="mb-0 text-muted text-truncate">Surat telah selesai diproses</p>
                            </div>
                            <div class="avatar-sm flex-shrink-0">
                                <span class="avatar-title text-bg-success rounded fs-3 widget-icon-box-avatar shadow">
