...
//create permission
Route::apiResource('/api-permissions', App\Http\Controllers\Api\IzinController::class)->middleware('auth:sanctum');

//create permission
Route::get('/izin', [App\Http\Controllers\Api\IzinController::class,'index'])->middleware('auth:sanctum');
//notes
